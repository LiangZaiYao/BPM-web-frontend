  ...
  <div class="wrapper">
    <side-bar>
      <template slot="links">
        ...
        <sidebar-link to="/human-analysis" :name="$t('sidebar.humanAnalysis')" icon="tim-icons icon-atom"/>
        <sidebar-link to="/friend-zone" :name="$t('sidebar.friendZone')" icon="tim-icons icon-molecule-40"/>
